...
use App\Http\Controllers\C_SaveRegistrasi_Home;
...
// Save Registrasi Paket Home
Route::post('/simpan/registrasi', [C_Registrasi_Home::class, 'Simpan_Registrasi'])->name('simpan.home_10');
